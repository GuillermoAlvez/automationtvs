...
public class Main {
    ...
    public static void main(String[] args) {
        System.setProperty("webdriver.chrome.driver", "C:\\Users\\jalvez\\Desktop\\TVS\\tvs_automation_jar_1.0-SNAPSHOT\\chromedriver.exe");
        WebDriver driver = new ChromeDriver();
        driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
        String lastname = java.util.UUID.randomUUID().toString();
        //LOGIN
        ...
        loggin_button.click();
        //COMPLETAR FORM DE NUEVO CONTACTO
        //  name
        ...
        // TODO: validar
        // LIMPIO CONTEXTO
        String deletebutton_xpath = "/html/body/div[3]/div[4]/table/tbody/tr/td[2]/div[2]/table/tbody/tr/td/form[1]/div/table/tbody/tr[3]/td[2]/input";
